## Descricao: criar um classificdor de imagem que treinara um modelo de rede CNN para classificacao de imagens usando 
#uma logica que mantem o dataset de treinamento equilibrado e alem de tudo randomiza o background.
#Esta alteração permitiria em tese, coletar pouco dataset da imagem em si.. possibilitando um treinamento mais direcionado
...
epochs = 8#Quantos conjuntos de batchs se repetem
...
dense1 = keras.layers.Dense(100,activation='relu',kernel_regularizer=keras.regularizers.l2(0.01))(flat_l2)
